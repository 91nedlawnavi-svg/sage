...
- **Phase 4 Layer 2 — IMPLEMENTED, GATED.** Store/extraction/builder/reconcile/targeted `[WHAT YOU KNOW]`, fact embeddings, provenance-boosted recall, and locked corrections exist and pass the offline integrated L2 felt-test. Still **gated off by default** (`SAGE_KNOWLEDGE_ENABLED=0`) pending live sign-off.
