...
Calm, minimal, dependable.

## Anti-references

- Futuristic JARVIS styling, sci-fi dashboards, glowing controls, and ornamental telemetry.
- Decorative gradients, glass effects, oversized branding, or animation without functional meaning.
- Dense admin interfaces that make conversation feel secondary.
- Sluggish display typography or unfamiliar controls where standard mobile patterns work better.
...
Use semantic controls, visible keyboard focus, WCAG AA contrast, 44-pixel touch targets, safe-area support, reduced-motion support, and text sizes that avoid mobile browser zoom. Never rely on hover, color alone, or animation to communicate state.
