...
def build_chat_messages(
    ...
    # Wave 2: pre-rendered block from hybrid retrieval (SQLite core) takes
    # precedence; legacy notebook path otherwise.
    parts.append("\n\n")
    knowledge_block = memory_block or build_knowledge_block(
